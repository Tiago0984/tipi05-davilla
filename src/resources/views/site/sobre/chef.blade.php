 <!-- Chef Section -->
 @php
 $features = asset('davilla/images/fundosobre4.jpg');
 @endphp
 <section class="chef-section" style="background-image: url('{{ $features }}');">
     <div class="auto-container">
         <div class="row">
             ...
             <div class="image-column col-lg-6 col-md-12 col-sm-12">
                 <div class="inner-column">
                     <figure class="image"><img src="{{ asset('davilla/images/Chef.png') }}" alt=""></figure>
                 </div>
             </div>
         </div>
     </div>
