                ...
                <div class="testimonial-block">
                    <div class="inner-box">
                        <div class="testimonial_img">
                            ...
                            <!-- Thumb Box -->
                            <figure class="thumb-box"><img src="{{ asset('davilla/images/depoimento1.svg') }}" alt=""></figure>
                ...
                <div class="testimonial-block">
                    <div class="inner-box">
                        <div class="testimonial_img">
                            ...
                            <!-- Thumb Box -->
                            <figure class="thumb-box"><img src="{{ asset('davilla/images/depoimento2.svg') }}" alt=""></figure>
                ...
                <div class="testimonial-block">
                    <div class="inner-box">
                        <div class="testimonial_img">
                            ...
                            <!-- Thumb Box -->
                            <figure class="thumb-box"><img src="{{ asset('davilla/images/depoimento3.svg') }}" alt=""></figure>
