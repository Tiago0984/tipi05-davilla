    ...
    <div class="rev_slider_wrapper fullwidthbanner-container" id="rev_slider_one_wrapper" data-source="gallery">
        <div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
            <ul>
                ...
                <li data-index="rs-{{ $loop->iteration + 3 }}" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="850" data-thumb="{{ asset('davilla/images/' . $banner->foto_banner) }}" data-delay="5999" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('davilla/images/' . $banner->foto_banner) }}" alt="{{ $banner->nome_banner ?? '' }}" title="{{ $banner->nome_banner ?? 'Banner' }}" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->

                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme"
                        id="slide-4-layer-44-{{ $loop->iteration }}"
                    ...
                    <div class="tp-caption   tp-resizeme"
                        id="slide-4-layer-40-{{ $loop->iteration }}"
                    ...
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption   tp-resizeme"
                        id="slide-4-layer-33-{{ $loop->iteration }}"
                        data-x="center" data-hoffset=""
                    ...
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption   tp-resizeme"
                        id="slide-4-layer-31-{{ $loop->iteration }}"
                        data-x="center" data-hoffset=""
                    ...
                    <!-- LAYER NR. 5 -->
                    <div class="tp-caption   tp-resizeme"
                        id="slide-4-layer-41-{{ $loop->iteration }}"
                        data-x="center" data-hoffset=""
                    ...
                    <div class="tp-caption tp-resizeme hide-sm"
                        id="slide-4-layer-42-{{ $loop->iteration }}"
                        data-x="398"
                        data-y="center" data-voffset=""
                        data-width="['none','none','none','none']"
                        data-height="['none','none','none','none']"
                    ...
                    <!-- LAYER NR. 7 -->
                    <div class="tp-caption tp-resizeme hide-sm"
                        id="slide-4-layer-43-{{ $loop->iteration }}"
                        data-x="1325"
                        data-y="center" data-voffset=""
                        data-width="['none','none','none','none']"
                        data-height="['none','none','none','none']"
