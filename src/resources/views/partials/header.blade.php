            ...
            <div class="nav-outer clearfix">
                ...
                <div class="outer-box clearfix">
                    ...
                    <div class="dashboard-btn">
                        <a href="{{ route('admin.dash') }}" title="Dashboard"><i class="fa fa-user"></i></a>
                    </div>
                    <!-- Shoppping Car -->
                    <div class="cart-btn">
                        ...
                        <div class="shopping-cart">
                            <ul class="shopping-cart-items">
                                <li class="cart-item">
                                    <img src="{{ asset('davilla/images/compra1.png') }}" alt="#" class="thumb" />
                                ...
                                <li class="cart-item">
                                    <img src="{{ asset('davilla/images/compra2.png') }}" alt="#" class="thumb" />
